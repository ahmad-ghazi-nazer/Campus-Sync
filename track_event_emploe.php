    ...
    <div class="flex flex-col h-screen">
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <div class="w-64 bg-gray-900 p-5 space-y-6">
                ...
                <div class="space-y-2">
                    <a class="flex items-center space-x-2 text-white hover:text-blue-30" href="Dashboard.php">
                        <i class="fas fa-home"></i>
                        <span>Dashboard</span>
                    </a>
                   
                    <a class="flex items-center space-x-2 text-blue-500 hover:text-blue-300" href="track_event_emploe.php">
