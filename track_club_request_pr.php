    ...
    <div class="flex flex-col h-screen">
        ...
        <div class="bg-black p-4 flex justify-between items-center">
            <div class="flex items-center space-x-4">
                ...
                <div class="text-3xl font-bold">
                    CAMPUS SYNC | TRACK CLUB REQUEST
                </div>
            </div>
            <div class="flex items-center space-x-4">
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <div class="flex-1 p-10 space-y-6">
                <img alt="Group of people posing for a photo at an event" classs="rounded responsive-image" src="PSUT DASHBOAR.webp" style="max-width: 100%; height: auto;">
                <div class="text-lg">
                    <table class="table-auto w-full">
                        <thead>
                            <tr>
                                ...
                                <th class="px-4 py-2">Approver Name</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php
