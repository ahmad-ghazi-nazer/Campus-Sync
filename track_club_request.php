...
$sql = "SELECT event_name, event_location, event_date, club_name, event_details, current_stage, request_status, approver_id FROM event_request";
                    ...
                    <table class="w-full text-base text-left text-white">
                        <thead class="text-lg text-white uppercase bg-gray-700">
                            <tr>
                                ...
                                <th class="py-3 px-6">Approver ID</th>
                            </tr>
                        </thead>
